...
public static void main(String[] args) throws InterruptedException {
    ...
    Thread.sleep(3000);
    driver.findElement(By.cssSelector(".art-control-screenshot")).click();
    driver.findElement(By.cssSelector(".art-control-pip")).click();
    Thread.sleep(3000);
    driver.findElement(By.cssSelector(".art-control-pip")).click();
    driver.findElement(By.cssSelector(".art-control-fullscreenWeb")).click();
    Thread.sleep(3000);
    driver.quit();
